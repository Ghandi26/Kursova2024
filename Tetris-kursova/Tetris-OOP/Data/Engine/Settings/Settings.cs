...
namespace Engine
{
    ...
    public class Settings
    {
        ...
        /// <summary>Текущее качество графики: 0 - низкая, 1 - высокая.</summary>
        ...
        private static void Graphic()
        {
            ...
            Tetris.Properties.Settings.Default.SpriteShape = Tetris.Properties.Settings.Default.Quality == 1;
            Tetris.Properties.Settings.Default.BackColor
                = Tetris.Properties.Settings.Default.Quality == 1
